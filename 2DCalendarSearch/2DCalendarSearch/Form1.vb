...
Public Class frm2DCalendarSearch
    Dim gintMonth(5, 6), intStartDay As Integer 'intStartDay is 0-6
    Dim gstrWeek() As String = {"Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"}


    Private Sub frm2DCalendarSearch_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        Dim intDayToFind As Integer = CInt(txtSearchFor.Text)

        For intRow = 0 To gintMonth.GetUpperBound(0)
            For intCol = 0 To gintMonth.GetUpperBound(1)
                If gintMonth(intRow, intCol) = intDayToFind Then
                    txtFound.Text = gstrWeek(intCol)
                End If
            Next
        Next
